        ...
        {users.map((user) => (
          ...
          >
            <div className="flex justify-between items-center">
              ...
              <button
                className="btn-primary px-4 py-2 rounded text-black font-medium disabled:opacity-50 hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition ease-in-out duration-300" // Added transition classes
